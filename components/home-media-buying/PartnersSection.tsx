                ...
                <div className="relative">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12">
                        {partners.map((partner, index) => (
                            <motion.div 
                                key={index}
                                className="group flex items-center justify-center w-[180px] mx-auto sm:w-full p-4 rounded-xl bg-black hover:bg-black/50 transition-all duration-300 border border-transparent hover:border-gray-500/30"
