                ...
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <a href="#client-results" className="text-gray-400 hover:text-white transition-colors">
                                    Client Results
                                </a>
                            </li>
                            <li>
                    ...
                    <div className="flex flex-col md:flex-row md:justify-between items-center md:items-start gap-4 text-center md:text-left">
                        <p className="text-gray-400 text-sm">
                            Copyright {new Date().getFullYear()}. Made by <Link 
                                ...
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="text-red-500 font-bold hover:text-red-600 hover:underline transition-colors"
                            >
                                Advantage Agency
                            </Link>
                        </p>
