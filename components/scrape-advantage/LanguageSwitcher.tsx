...
export default function LanguageSwitcher() {
    ...
    const changeLanguage = (newLocale: string) => {
        ...
        // Make sure we're always redirecting to the scrape-advantage page
        if (!currentPath.includes('/scrape-advantage')) {
            router.push(`/${newLocale}/scrape-advantage`);
            setIsLangDropdownOpen(false);
            return;
        }
        ...
        // Replace the locale segment (which is the second segment, index 1)
    ...
    return (
        <div className="w-full max-w-6xl mx-auto flex justify-end relative sm:absolute md:right-4" ref={dropdownRef}>
            <button 
