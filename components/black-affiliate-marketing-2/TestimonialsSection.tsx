...
import video5 from '../../../../public/img/black-affiliate-marketing/video-5.mp4';
import placeholder5 from '../../../../public/img/black-affiliate-marketing/video-5-placeholder.webp';
        ...
        <div className="space-y-4">
          ...
          <div className="relative cursor-pointer transition-transform duration-300 hover:scale-105" onClick={() => openImage('/img/black-affiliate-marketing/testimonial-8.webp')}>
            <Image 
              ...
              sizes="(max-width: 768px) 100vw, 33vw"
              blurDataURL="data:image/jpeg;base64,"
            />
          </div>
