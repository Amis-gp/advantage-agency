    ...
    <section className="space-y-12 mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="bg-black/40 backdrop-blur-sm p-8 rounded-2xl border border-red-600/50 transition-all duration-300 shadow-2xl shadow-red-600/20">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              You have the opportunity to collaborate directly with us, leveraging all our expertise, and diligently following the precise, step-by-step guidance we're prepared to provide.
            </p>
            <p>
              It may not be a simple endeavor, but we are committed to ensuring your success in the most effective and efficient manner possible.
            </p>
            <div className="mt-8">
