...
export const EMAIL_SLIDES = [
    {
        ...
        content: [
            "offers.offers.email.slide1.content.0",
            "offers.offers.email.slide1.content.1"
        ],
        link: { 
    ...
    },
    {
        ...
        list: Array.from({ length: 5 }, (_, i) => ({
            title: `offers.offers.email.slide2.list.${i}.title`,
            description: `offers.offers.email.slide2.list.${i}.description`
        }))
    },
    {
        logo: "/img/offers/cold-email-logo.svg",
        ...
        list: Array.from({ length: 1 }, (_, i) => ({
            ...
            description: `offers.offers.email.slide3.list.${i}.description`
        })),
        link1: { 
            text: "offers.offers.email.slide3.caseLink", 
            href: "/cases/v13"
        },
        content: ["offers.offers.email.slide3.content"],
        link: { 
            text: "offers.offers.email.slide3.strategyLink", 
            href: "#form" 
        }
    }
];
