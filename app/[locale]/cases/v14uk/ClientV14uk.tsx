  ...
  return (    
    <div className="text-black bg-white max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="mt-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-12 leading-tight">
            ...
            у крипто-нішах для Justin через Cold Email ✨
        </h1>
          ...
          <div className="my-12 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            <div>
              ...
              <ul className="space-y-2 text-xl leading-relaxed text-gray-800">
                ...
                <li>✔️ Дослідити ефективність різних headline</li>
      ...
      <div className="bg-gradient-to-r from-gray-50 to-white rounded-2xl p-8 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-xl font-bold">Складно вийти в inbox</h3>
                </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700">
                    Люди не довіряють холодним email, особливо без очевидної вигоди.
                </p>
            </div>
        ...
        <div className="space-y-4">
          <div className="flex gap-3">
            ...
            <p className="text-lg text-gray-700">Ліди були "тепліші" – ми одразу виключили нецільові контакти.</p>
          </div>
          <div className="flex gap-3">
            <span className="text-green-600 text-xl">✓</span>
            <p className="text-lg text-gray-700">Перевірили валідність email – видалили невалідні адреси, зменшивши bounce rate.</p>
          </div>
        </div>
    ...
    <section className="my-16">
      ...
      <div className="border-t-2 border-gray-100 pt-6">
        ...
        <ul className="space-y-2 text-gray-600 pl-4">
          <li>• "Ваш крипто-проект може отримати 10x growth..."</li>
          <li>• "3 ключові помилки крипто-маркетингу в 2024"</li>
          <li>• "Як ми залучили $500k інвестицій за 2 місяці"</li>
        </ul>
      </div>
    </section>
    ...
    <section className="my-16">
      <h2 className="text-3xl font-bold mb-8">
        3. Оптимізація кампанії після перших 3000 листів
      </h2>

      <p className="text-xl mb-8">
        Замість того, щоб просто "палити" базу, ми регулярно аналізували результати:
      </p>
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-start gap-4 border-b border-gray-100 pb-8">
          ...
          <div>
            <p className="text-lg">
              Доопрацьовували headline – деякі просто не працювали, тому ми їх заміняли
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-lg">
              Тестували фоллоу-апи – відповідали на "теплі" контакти більш детально
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-[300px] mx-auto">
          <div className="relative">
            ...
            <p className="mt-4 text-sm text-gray-600 text-center">
              Відгук від Justin про результати кампанії
            </p>
          </div>
        </div>
      </div>
