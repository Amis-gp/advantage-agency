      ...
      <section className="mb-12 mt-8 px-4 py-8 bg-gray-100">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center">
          <div className="md:w-1/3 mb-4 md:mb-0">
            ...
            <p className="text-center">owner of <a href="https://render-market.netlify.app/" target="_blank" rel="noopener noreferrer" className="text-amber-600"><strong><u>Studio Render Market</u></strong></a></p>
          </div>
